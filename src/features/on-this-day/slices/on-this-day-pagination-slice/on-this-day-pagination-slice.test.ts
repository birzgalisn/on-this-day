...
import {
  onThisDayPaginationReducer,
  OnThisDayPaginationState,
  paginate,
} from '~/features/on-this-day/slices/on-this-day-pagination-slice';
...
} satisfies OnThisDayPaginationState;
...
describe('onThisDaySlice', () => {
  ...
  it('should paginate initialized events', () => {
    ...
    expect(onThisDayPaginationReducer(STATE, action)).toEqual(expected);
  });
